# Propuesta grupal – [Laureano Lafaurie - Emmanuel Monterrosa - Jhoreinis Anaya]
...
La aplicación seguirá los principios de Clean Architecture, organizando el proyecto en tres capas principales: _Presentation_, _Domain_ y _Data_.
...
5. Cada estudiante evalúa a sus compañeros (sin autoevaluación por defecto).
...
El usuario accede con sus credenciales de roble, y el sistema detecta si se trata de un estudiante o un profesor, y lo envia a las pantallas correspondientes.

![Pantalla login](images/login.png)

### 4.2 Creación / unión a curso

**Profesor:**
El profesor crea un curso dentro de la aplicación e invita a los estudiantes mediante un código privado o mecanismo de verificación **_(Este mecanismo puede variar según los requerimientos futuros del proyecto)_**. Puede administrar múltiples cursos desde su panel principal.
...
### 4.3 Importación de grupos desde Brightspace
